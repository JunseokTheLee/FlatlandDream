...
public class Movement : MonoBehaviour
{
    ...
    void UpdateMove()
    {
        ...
        if (!isGrounded)
        {
            // Apply gravity gradually when in air
            velocityY += gravity * Time.deltaTime;
        }

        Vector3 velocity = (transform.forward * currentDir.y * mult+ transform.right * currentDir.x) * Speed + Vector3.up * velocityY;
        ...
        {
            // Smoothen the falling transition
